...
interface In { skillId: string; prompt: string; answer: string; correct: boolean; latencyMs: number; ts: number; clientId: string; level?: number; review?: boolean; itemKey?: string; score?: number; expected?: number; theta?: number; beta?: number; ignored?: boolean; probe?: boolean }
...
export async function POST(req: Request) {
  ...
  const q = sql();
  await q.query(
    `INSERT INTO attempts (user_token, skill_id, prompt, answer, correct, latency_ms, ts, client_id, level, review, item_key, score, expected, theta, beta, ignored, probe)
     SELECT * FROM UNNEST($1::text[], $2::text[], $3::text[], $4::text[], $5::bool[], $6::int[], $7::timestamptz[], $8::text[], $9::smallint[], $10::bool[], $11::text[], $12::real[], $13::real[], $14::real[], $15::real[], $16::bool[], $17::bool[])
