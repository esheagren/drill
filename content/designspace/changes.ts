...
export const CHANGES: { date: string; screen: string; what: string; pr: number }[] = [
  { date: "2026-09-03", screen: "V2", what: "Percent widget rebuilt as steps: find 10%, build the percent from tenths, halves and hundredths (or a round number minus a little), add it on or take it off — one row per step, each a sentence and a bar, tap for the next. Replaces the multiplier-chain sliders (dragging a parameter never showed the procedure). Sentences for percent items use the same words", pr: 74 },
  { date: "2026-09-03", screen: "V1", what: "The keypad shows only on touch screens; on a computer you type (digits, . e / ^, ⌫, ↵). Exponent answers accept 10e12 for 10^12 — the keypad has e and no ^", pr: 73 },
