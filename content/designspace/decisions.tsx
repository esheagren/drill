...
const QUESTION: Option[] = [
  ...
  { id: "top-left", name: "Top left, small", note: "the question as a caption, like the feedback state — no reflow between states — what is live", current: true, layer: <><div className="absolute left-8 top-[60px] text-[26px]" style={Serif}>47 × 6</div><div className="absolute inset-x-0 top-[300px] text-center text-[44px] font-light text-gray-300 tabular-nums">28<Cursor /></div></> },
